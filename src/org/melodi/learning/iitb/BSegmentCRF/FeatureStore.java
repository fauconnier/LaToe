...
import org.melodi.learning.iitb.BSegmentCRF.BSegmentTrainer.MatrixWithRange;
import org.melodi.learning.iitb.CRF.DataSequence;
import org.melodi.learning.iitb.CRF.Feature;
import org.melodi.learning.iitb.CRF.FeatureGenCache;
import org.melodi.learning.iitb.CRF.LogSparseDoubleMatrix1D;
import org.melodi.learning.iitb.CRF.RobustMath;
...
public class FeatureStore {
    ...
    public void checkMatrix(DoubleMatrix1D ri_Y, MatrixWithRange openRi) {
        ...
        if ((openRi.end < 0) || (openRi.start < 0))
            return;
        assert(getExactR(openRi.start,openRi.end,new LogSparseDoubleMatrix1D(openRi.mat.size())).equals(ri_Y));
    }
    /**
     * @param ri_Y
     * @param openRi
