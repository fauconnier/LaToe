package org.melodi.learning.iitb.MaxentClassifier;
 ...
 * classification where the features are provided as attributes of the instances
 * to be classified. The number of classes can be more than two.
 * 
...
public class MaxentClassifier {
	...
	public MaxentClassifier(Options opts) throws Exception {
		...
		this.opts = opts;
		// read all parameters
		featureGen = new FeatureGenRecord(dataDesc.numColumns,
				dataDesc.numLabels);
	...
	// méthode publique test()
	public void test(Iterator<DataRecord> dataIter, boolean testOnly)
			throws IOException {
