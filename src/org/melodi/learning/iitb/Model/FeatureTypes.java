...
//    private FeatureGenImpl fgen;
    ...
    public int maxFeatureId() {
		org.melodi.learning.iitb.Utils.LogMessage.issueWarning("WARNING : Class " + getClass().getName() + " does not implement maxFeatureId(). Returning default value. Please refer to the documentation.");
    ...
    public void train(DataSequence data, int pos) {
		if(requiresTraining()) {
			org.melodi.learning.iitb.Utils.LogMessage.issueWarning("WARNING : Class " + getClass().getName() + " does not implement the train(DataSequence, int) method. Please implement the train() methods properly.");
		}
	}	
    /**
    ...
    public void train(SegmentDataSequence sequence, int segStart, int segEnd) {
		if(requiresTraining()) {
			org.melodi.learning.iitb.Utils.LogMessage.issueWarning("WARNING : Class " + getClass().getName() + " does not implement the train(SegmentDataSequence, int, int) method. Calling train(DataSequence, int) instead. Please implement the train() methods properly.");
    ...
    public void trainingDone() {
        if(requiresTraining()) {
            org.melodi.learning.iitb.Utils.LogMessage.issueWarning("WARNING : Class " + getClass().getName() + " does not implement the train(SegmentDataSequence, int, int) method. Calling train(DataSequence, int) instead. Please implement the trainDone() methods properly.");
        }
    }
    public void disable() {
        disabled=true;
