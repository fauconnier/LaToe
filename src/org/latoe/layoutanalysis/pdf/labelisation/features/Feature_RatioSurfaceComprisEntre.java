...
public class Feature_RatioSurfaceComprisEntre extends FeatureTypes {
	/**
	 * 
	 */
	...
	public Feature_RatioSurfaceComprisEntre (FeatureGenImpl m, float borneInf, float borneSup) {
		super(m);
		numStates = m.numStates();
		fname = "RatioSurfaceEntre"+borneInf+"et"+borneSup;
                this.bInf = borneInf;
                this.bSup = borneSup;
	}
	...
	public boolean startScanFeaturesAt(DataSequence data, int prevPos, int pos) {
                ...
                if (currChunk.ratio > this.bInf && currChunk.ratio <= this.bSup ) {
                    stateId = 0;
                    return true;
                } 
                else{
