...
public class Feature_ContrasteTypePolice extends FeatureTypes {
	/**
	 * 
	 */
	...
	public Feature_ContrasteTypePolice (FeatureGenImpl m) {
		super(m);
		numStates = m.numStates();
		fname = "ContrasteTypePolice";
	}
	...
	public boolean startScanFeaturesAt(DataSequence data, int prevPos, int pos) {
                ...
                if(prevPos != -1){
                    ...
                    if (!currChunk.modeTypePolice.equals(prevChunk.modeTypePolice)) {
                            stateId = 0;
                            return true;
                    } 
                }
