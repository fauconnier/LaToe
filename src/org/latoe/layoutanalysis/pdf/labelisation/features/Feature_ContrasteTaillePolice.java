...
public class Feature_ContrasteTaillePolice extends FeatureTypes {
	/**
	 * 
	 */
	...
	public Feature_ContrasteTaillePolice (FeatureGenImpl m) {
		super(m);
		numStates = m.numStates();
		fname = "ContrasteTaillePolice";
	}
	...
	public boolean startScanFeaturesAt(DataSequence data, int prevPos, int pos) {
                ...
                if(prevPos != -1){
                    ...
                    if (currChunk.modeTaillePolice != prevChunk.modeTaillePolice  ) {
